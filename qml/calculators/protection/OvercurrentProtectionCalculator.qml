...
Item {
    ...
    Popup {
        id: test
        visible: cableParamsCard.open
        onAboutToHide: cableParamsCard.open = false
        modal: true
                ...
                ColumnLayout {
                    ...
                    WaveCard {
                        ...
                        GridLayout {
                            ...
                            // Cable parameters
                            Label { text: "Cross Section (mm²):" ; Layout.minimumWidth: 180}
                            SpinBoxRound {
                                from: 10
                                to: 500
                    ...
                    WaveCard {
                        ...
                        GridLayout {
                            ...
                            Label { text: "System Fault Level (MVA):" ; Layout.minimumWidth: 180}
                            SpinBoxRound {
                                from: 50
                                to: 1000
